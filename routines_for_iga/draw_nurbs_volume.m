...
%  Summary:
%  
%  This routine draws the NURBS volume that is specified by the knot
...
%  
%      draw_nurbs_volume(knots1, knots2, knots3, nodes, p1, p2, p3);
%  
%  where,
%  
%      knots1, knots2, knots3 are the knot vectors (column vectors)
%      nodes is an array of nodes
%      p1, p2, p3 are the degrees of the NURBS
%  
%  
%  Output:
%  
%  1. Plot of the NURBS volume
%--------------------------------------------------------------------------
function draw_nurbs_volume(knots1, knots2, knots3, nodes, p1, p2, p3)
                ...
                for j3 = 1 : numPointsPerElementCoordinate
                    for j2 = 1 : numPointsPerElementCoordinate
                        for j1 = 1 : numPointsPerElementCoordinate
                            ...
                            x(j1, j2, j3) = (nodes_e(1, :) * basis_der0) / w;
                            y(j1, j2, j3) = (nodes_e(2, :) * basis_der0) / w;
                            z(j1, j2, j3) = (nodes_e(3, :) * basis_der0) / w;
...
%--------------------------------------------------------------------------
%  This routine draws a contour of the 3D NURBS element. Points are
