...
%  Summary:
%  
%  This routine draws the B-spline surface that is specified by the knot
...
%  
%      draw_bspline_surface(knots1, knots2, nodes, p1, p2);
%  
%  where,
%  
%      knots1, knots2 are the knot vectors (column vectors)
%      nodes is an array of nodes
%      p1, p2 are the degrees of the B-splines
%  
%  
%  Output:
%  
%  1. Plot of the B-spline surface
%--------------------------------------------------------------------------
function draw_bspline_surface(knots1, knots2, nodes, p1, p2)
    ...
    % Number of points where we evaluate the fields
        ...
        for e1 = 1 : numElements1
            ...
            for j2 = 1 : numPointsPerElementCoordinate
                for j1 = 1 : numPointsPerElementCoordinate
                    ...
                    x(j1, j2) = nodes_e(1, :) * basis_der0;
                    
                    y(j1, j2) = nodes_e(2, :) * basis_der0;
                    
                    if (numDimensions == 3)
                        z(j1, j2) = nodes_e(3, :) * basis_der0;
                    end
