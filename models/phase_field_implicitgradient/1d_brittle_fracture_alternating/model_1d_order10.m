...
%  we can validate the 10th-order phase field theory for brittle fracture.
%  
...
%--------------------------------------------------------------------------
function model_1d_order10(path_to_assembly_directory, path_to_results_directory, restartTime)
    % Feedback for user
    fprintf('\n');
    fprintf('----------------------------------------------------------------\n');
    fprintf('----------------------------------------------------------------\n\n');
    ...
    constant_G_c       = material_G_c * material_A / ((gamma_1p / p_exp) * material_ell_0);
...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 =                                 constant_G_c * (alpha2  * constant_ell_0_sq  );
                C22 =                                 constant_G_c * (alpha4  * constant_ell_0_sq^2);
                C33 =                                 constant_G_c * (alpha6  * constant_ell_0_sq^3);
                C44 =                                 constant_G_c * (alpha8  * constant_ell_0_sq^4);
                C55 =                                 constant_G_c * (alpha10 * constant_ell_0_sq^5);
