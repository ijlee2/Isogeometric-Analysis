        ...
        if (x_left <= 0 && 0 < x_right)
            if (abs(x_left) < 1e-12)
                ...
                for m = 0 : (p_exp - 1)
                    ...
                    elseif (m == 4)
                        basis_physical_derm = JacobianMatrix_inv^4 * basis_der4(:, numQuadraturePoints + 1);
            ...
            elseif (abs(x_right) < 1e-12)
                ...
                for m = 0 : (p_exp - 1)
                    ...
                    elseif (m == 4)
                        basis_physical_derm = JacobianMatrix_inv^4 * basis_der4(:, numQuadraturePoints + 2);
