...
%           f1_e  = elementVector;
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 = constant_stiffness * (c_der0^2 + 4/3 * material_ell_0^2 * c_der1^2 + 16/27 * material_ell_0^4 * c_der2^2);
...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 = constant_stiffness * 4/3   * constant_ell_0_sq   * u_der1^2 + constant_G_c * (4/3    * constant_ell_0_sq  );
                C22 = constant_stiffness * 16/27 * constant_ell_0_sq^2 * u_der1^2 + constant_G_c * (16/27  * constant_ell_0_sq^2);
