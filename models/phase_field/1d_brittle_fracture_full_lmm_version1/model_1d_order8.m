    ...
    for k = restartTime : maxNewtonsMethod
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                vector_of_constants = [constant1; constant2; constant3];
                ...
                % Additional terms from Lagrange multiplier method
                C11 = u3_e(1) * (2 * constant1);
                C12 = u3_e(2) * (2 * constant2);
                C13 = u3_e(3) * (2 * constant3);
                ...
                K12_e = K12_e + (w(q_e) * Jacobian * C10) * (basis_physical_der1 * basis_physical_der0') ...
                              ...
                              + (w(q_e) * Jacobian * C13) * (basis_physical_der1 * basis_physical_der3');
                
                K23_e(:, 1) = K23_e(:, 1) + (w(q_e) * Jacobian * constant1 * u_der1) * basis_physical_der1;
                K23_e(:, 2) = K23_e(:, 2) + (w(q_e) * Jacobian * constant2 * u_der1) * basis_physical_der2;
                K23_e(:, 3) = K23_e(:, 3) + (w(q_e) * Jacobian * constant3 * u_der1) * basis_physical_der3;
                ...
                C22 = C22 + u3_e(2) * constant2;
                C33 = C33 + u3_e(3) * constant3;
                ...
                C2 = C2 + u3_e(2) * constant2;
                C3 = C3 + u3_e(3) * constant3;
