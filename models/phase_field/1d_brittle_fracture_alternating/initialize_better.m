...
%  
%      initialize_better(order, path_to_assembly_directory, path_to_results_directory)
%  
%  where,
%  
...
%--------------------------------------------------------------------------
function initialize_better(order, path_to_assembly_directory, path_to_results_directory)
