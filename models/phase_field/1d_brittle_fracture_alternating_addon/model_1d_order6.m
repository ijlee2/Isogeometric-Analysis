...
%           f1_e  = elementVector;
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                %----------------------------------------------------------
                degradation_function = c_der0^2 + alpha1 * (material_ell_0 * c_der1)^4 + alpha2 * (material_ell_0^2 * c_der2)^6;
...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for k = 0 : maxNewtonsMethod
            ...
            for e = 1 : numElements1
                ...
                for q_e = 1 : numQuadraturePointsPerElement
                    ...
                    C11 = constant1 + constant_G_c * (4/3    * constant_ell_0_sq  );
                    C22 = constant2 + constant_G_c * (16/27  * constant_ell_0_sq^2);
                    ...
                    C1 = constant1 + constant_G_c * (4/3    * constant_ell_0_sq   * c_der1);
                    C2 = constant2 + constant_G_c * (16/27  * constant_ell_0_sq^2 * c_der2);
        ...
        % -----------------------------------------------------------------
        %------------------------------------------------------------------
        save(sprintf('%sfile_results_alternation%d', path_to_results_directory, alternation), 'u1', 'u2', 'alpha1', 'alpha2', '-v6');
    end
