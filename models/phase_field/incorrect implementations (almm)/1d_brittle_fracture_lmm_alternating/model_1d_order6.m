...
function model_1d_order6(path_to_assembly_directory, path_to_results_directory)
    ...
    load(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2');
    ...
    for alternation = 1 : maxAlternations
        ...
        % -----------------------------------------------------------------
        %------------------------------------------------------------------
        save(sprintf('%sfile_results_alternation%d', path_to_results_directory, alternation), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2', '-v6');
    end
