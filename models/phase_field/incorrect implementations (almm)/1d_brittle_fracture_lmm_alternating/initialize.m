...
function initialize(order, path_to_assembly_directory, path_to_results_directory)
    ...
    switch order
        case 2
            ...
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', '-v6');
        ...
        case 4
            ...
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', 'lambda1', '-v6');
        ...
        case 6
            ...
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2', '-v6');
        ...
        case 8
            ...
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2', 'lambda3', '-v6');
