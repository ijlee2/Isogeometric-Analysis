...
function model_1d_order8(path_to_assembly_directory, path_to_results_directory)
    ...
    load(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2', 'lambda3');
    ...
    for alternation = 1 : maxAlternations
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                lambda1(q) = lambda1(q) + LMM_beta * constant0 * (constant_ell_0_sq   * c_der1^2);
                lambda2(q) = lambda2(q) + LMM_beta * constant0 * (constant_ell_0_sq^2 * c_der2^2);
                lambda3(q) = lambda3(q) + LMM_beta * constant0 * (constant_ell_0_sq^3 * c_der3^2);
        ...
        % -----------------------------------------------------------------
        %------------------------------------------------------------------
        save(sprintf('%sfile_results_alternation%d', path_to_results_directory, alternation), 'u1', 'u2', 'lambda0', 'lambda1', 'lambda2', 'lambda3', '-v6');
    end
