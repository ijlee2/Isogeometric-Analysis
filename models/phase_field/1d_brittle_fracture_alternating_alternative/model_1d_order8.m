...
function model_1d_order8(path_to_assembly_directory, path_to_results_directory, restartTime)
    ...
    fprintf('----------------------------------------------------------------\n');
    fprintf('----------------------------------------------------------------\n\n');
    fprintf('  Alternative 8th-order phase field theory in 1D.\n\n');
...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 =                                 constant_G_c * (25/16           * constant_ell_0_sq  );
                C22 =                                 constant_G_c * (1875/2048       * constant_ell_0_sq^2);
                C33 =                                 constant_G_c * (15625/65536     * constant_ell_0_sq^3);
                C44 =                                 constant_G_c * (390625/16777216 * constant_ell_0_sq^4);
