...
function model_1d_order6(path_to_assembly_directory, path_to_results_directory, restartTime)
    ...
    fprintf('----------------------------------------------------------------\n');
    fprintf('----------------------------------------------------------------\n\n');
    fprintf('  Alternative 6th-order phase field theory in 1D.\n\n');
...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 =                                 constant_G_c * (27/16    * constant_ell_0_sq  );
                C22 =                                 constant_G_c * (243/256  * constant_ell_0_sq^2);
                C33 =                                 constant_G_c * (729/4096 * constant_ell_0_sq^3);
