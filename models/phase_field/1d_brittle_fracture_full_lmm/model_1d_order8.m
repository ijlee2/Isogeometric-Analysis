    ...
    for k = restartTime : maxNewtonsMethod
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                vector_of_constants = [constant0; constant1; constant2; constant3];
                ...
                C12 =       u3_e(3) * (2 * constant2);
                C13 =       u3_e(4) * (2 * constant3);
                ...
                K23_e(:, 3) = K23_e(:, 3) + (w(q_e) * Jacobian * constant2 * u_der1) * basis_physical_der2;
                K23_e(:, 4) = K23_e(:, 4) + (w(q_e) * Jacobian * constant3 * u_der1) * basis_physical_der3;
                ...
                C22 = C22 + u3_e(3) * constant2;
                C33 = C33 + u3_e(4) * constant3;
                ...
                C2 = C2 + u3_e(3) * constant2;
                C3 = C3 + u3_e(4) * constant3;
