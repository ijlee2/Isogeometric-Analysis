...
%               basis1_physical_der0 =                         basis1_der0(:, q_e);
                ...
                C11 = constant_stiffness * (c_der0^2 + material_ell_0^2 * c_der1^2 + 3/8 * material_ell_0^4 * c_der2^2 + 1/16 * material_ell_0^6 * c_der3^2);
...
%               basis1_physical_der0 =                         basis1_der0(:, q_e);
                ...
                C11 = constant_stiffness *        constant_ell_0_sq   * u_der1^2 + constant_G_c * (        constant_ell_0_sq  );
                C22 = constant_stiffness * 3/8  * constant_ell_0_sq^2 * u_der1^2 + constant_G_c * (3/8   * constant_ell_0_sq^2);
                C33 = constant_stiffness * 1/16 * constant_ell_0_sq^3 * u_der1^2 + constant_G_c * (1/16  * constant_ell_0_sq^3);
