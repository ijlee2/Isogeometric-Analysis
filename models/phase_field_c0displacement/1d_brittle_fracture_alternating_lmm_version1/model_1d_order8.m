...
%                   basis1_physical_der0 =                         basis1_der0(:, q_e);
                    ...
                    c_der2 = u2_e * basis2_physical_der2;
                    c_der3 = u2_e * basis2_physical_der3;
                    c_der4 = u2_e * basis2_physical_der4;
                    ...
                    K23_e(:, 2) = K23_e(:, 2) + (w(q_e) * Jacobian2 * constant2 * c_der2) * basis2_physical_der2;
                    K23_e(:, 3) = K23_e(:, 3) + (w(q_e) * Jacobian2 * constant3 * c_der3) * basis2_physical_der3;
                    ...
                    f2_e = f2_e + (w(q_e) * Jacobian2 * C0) * basis2_physical_der0 ...
                                ...
                                + (w(q_e) * Jacobian2 * C4) * basis2_physical_der4;
