...
%           f1(index_equation1) = f1(index_equation1) + f1_e;
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                if (alternation == (restartTime + 1))
                    ...
                    K33_e = K33_e + (w(q_e) * Jacobian * C00) * (basis_physical_der0 * basis_physical_der0') ...
                ...
                C0 = constant_G_c - constant_stiffness * u_der1^2 * c_der0;
        ...
        for e = 1 : numElements1
            ...
            % Find the coefficients of the auxiliary field
