...
%  we can validate the 3rd-order, infinitely differentiable phase field
...
function model_1d_order3(path_to_assembly_directory, path_to_results_directory, restartTime)
    ...
    fprintf('----------------------------------------------------------------\n');
    fprintf('----------------------------------------------------------------\n\n');
    fprintf('  3rd-order, infinitely differentiable phase field theory in 1D.\n\n');
...
%           f1_e  = elementVector;
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                %----------------------------------------------------------
                degradation_function = 3 * c_der0^2 - 2 * c_der0^3;
