...
%  we can validate the 4th-order, infinitely differentiable phase field
...
function model_1d_order4(path_to_assembly_directory, path_to_results_directory, restartTime)
    ...
    fprintf('----------------------------------------------------------------\n');
    fprintf('----------------------------------------------------------------\n\n');
    fprintf('  4th-order, infinitely differentiable phase field theory in 1D.\n\n');
        ...
        for k = 0 : maxNewtonsMethod
            ...
            for e = 1 : numElements1
                ...
                for q_e = 1 : numQuadraturePointsPerElement
                    ...
                    C0 = constant_stiffness * (3 * c_der0 * (1 - c_der0) * u_der1^2) + constant_G_c * (c_der0 * (16 * minus_log_c_sqrt^5 - 20 * minus_log_c_sqrt^3));
