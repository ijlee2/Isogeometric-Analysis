...
function model_1d_order2(path_to_assembly_directory, path_to_results_directory, restartTime)
    ...
    constant_G_c       = 8/(3*sqrt(2*pi)) * material_G_c * material_A / material_ell_0;
...
%                C10 = 2 * constant_stiffness * c_der0 * u_der1;
                ...
                % Coefficients for the (regular) phase field theory.
                % The subscripts denote the derivatives of N_A and N_B.
%                C00 = constant_stiffness * u_der1^2 + constant_G_c * (4 * minus_log_c^3 - 18 * minus_log_c^2 + 12 * minus_log_c);
%                C11 =                                 constant_G_c * constant_ell_0_sq;
                C00 = constant_stiffness * (3 - 6 * c_der0) * u_der1^2 + constant_G_c * (4 * minus_log_c^3 - 18 * minus_log_c^2 + 12 * minus_log_c);
                C11 =                                                    constant_G_c * constant_ell_0_sq;
...
%                C1 = constant_stiffness * c_der0^2 * u_der1;
                ...
                % Coefficients for the (regular) phase field theory.
                % The subscript denotes the derivative of N_A.
%                C0 = constant_stiffness * (c_der0 * u_der1^2) + constant_G_c * (c_der0 * (4 * minus_log_c^3 - 6 * minus_log_c^2));
%                C1 =                                            constant_G_c * (c_der1 * constant_ell_0_sq);
                C0 = constant_stiffness * (3 * c_der0 * (1 - c_der0) * u_der1^2) + constant_G_c * (c_der0 * (4 * minus_log_c^3 - 6 * minus_log_c^2));
                C1 =                                                               constant_G_c * (c_der1 * constant_ell_0_sq);
