                ...
                if (abs(x_left) < 1e-12)
                    ...
                    for m = 0 : 2 : 2
                        ...
                        elseif (m == 2)
                            ...
                            basis_physical_derm = constant_ell_0_sq * basis_physical_derm;
                        ...
                        columns_for_K22(index) = (numDOFs + m/2 + 1) * ones(constant_p1p1, 1);
                        values_for_K22(index)  = basis_physical_derm;
                        ...
                        rows_for_K22(index)    = (numDOFs + m/2 + 1) * ones(constant_p1p1, 1);
