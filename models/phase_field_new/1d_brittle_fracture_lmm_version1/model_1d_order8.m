    ...
    for k = restartTime : maxNewtonsMethod
        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                C11 = C11 + (2 * l0_der0 * c_der0) + (2 * constant_ell_0_sq * l2_der0 * c_der2);
                ...
                C12 =       (2 * constant_ell_0_sq * l2_der0 * u_der1);
                ...
                %----------------------------------------------------------
                % Additional terms from Lagrange multiplier method
                C10 = 2 * constant_ell_0_sq * c_der2 * u_der1;
                ...
                %----------------------------------------------------------
                % Additional terms from Lagrange multiplier method
                C20 = constant_ell_0_sq * u_der1^2;
                ...
                % Additional terms from Lagrange multiplier method
                C1 = C1 + (2 * l0_der0 * c_der0 * u_der1) + (2 * constant_ell_0_sq * l2_der0 * c_der2 * u_der1);
                ...
                C2 = C2 + (constant_ell_0_sq * l2_der0 * u_der1^2);
                ...
                %----------------------------------------------------------
                % Additional terms from Lagrange multiplier method
                C0 = constant_ell_0_sq * c_der2 * u_der1^2;
