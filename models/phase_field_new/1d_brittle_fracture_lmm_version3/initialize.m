...
function initialize(order, path_to_assembly_directory, path_to_results_directory)
    ...
    switch order
        case 2
            l0 = zeros(numDOFs, 1);
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'l0', '-v6');
        ...
        case 6
            ...
            save(sprintf('%sfile_results_alternation%d', path_to_results_directory, 0), 'u1', 'u2', 'l0', 'l2', '-v6');
