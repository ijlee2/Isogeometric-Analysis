...
%--------------------------------------------------------------------------
function generate_assemblyFile(order, degree, numRefinements)
    % Check for errors
    ...
    %  Elevate the degrees
    %----------------------------------------------------------------------
    % Elevate the degree to p in the x-direction
    if (patches(1).p1 < degree)
    ...
    %----------------------------------------------------------------------
    generate_bcFile(order, degree, numRefinements);
end
