        ...
        for e = 1 : numElements1
            ...
            for q_e = 1 : numQuadraturePointsPerElement
                ...
                switch order
                    ...
                    case 6
                        crack_density = (1 - u2_der0)^2 + 27/16 * constant_ell_0_sq * u2_der1^2 + 243/256   * constant_ell_0_sq^2 * u2_der2^2 + 729/4096    * constant_ell_0_sq^3 * u2_der3^2;
                        
                    case 8
                        crack_density = (1 - u2_der0)^2 + 25/16 * constant_ell_0_sq * u2_der1^2 + 1875/2048 * constant_ell_0_sq^2 * u2_der2^2 + 15625/65536 * constant_ell_0_sq^3 * u2_der3^2 + 390625/16777216 * constant_ell_0_sq^4 * u2_der4^2;
