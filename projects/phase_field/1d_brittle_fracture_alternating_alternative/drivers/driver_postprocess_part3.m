function driver_postprocess_part3()
    ...
    for j = 1 : size(orders, 1)
        ...
        path_to_assembly_directory = sprintf('../assembly_files/order%d/', orders(j));
        
        % Set path to the results directory
        path_to_results_directory = sprintf('../results/order%d/', orders(j));
        ...
        postprocess_part3(orders(j), path_to_assembly_directory, path_to_results_directory, path_to_outputs_directory);
    end
