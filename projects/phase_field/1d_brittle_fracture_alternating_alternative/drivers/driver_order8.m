function driver_order8()
    ...
    for i = 1 : size(numRefinements, 1)
        ...
        path_to_assembly_directory = sprintf('../assembly_files/order8/numRefinements%d/', numRefinements(i));
        
        % Set path to the results directory
        path_to_results_directory = sprintf('../results/order8/numRefinements%d/', numRefinements(i));
        ...
        model_1d_order8(path_to_assembly_directory, path_to_results_directory, 0);
    end
