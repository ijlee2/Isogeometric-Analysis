...
%  Summary:
%  
%  This routine plots the displacement and phase fields at each Newton's
%  iteration for the problem of 1D cracked bar in tension.
%  
%  
%  Instructions:
%  
...
function postprocess_part1(path_to_assembly_directory, path_to_results_directory, path_to_outputs_directory)
    ...
    for k = 0 : maxNewtonsMethod
        ...
        load(sprintf('%sfile_results_iteration%d', path_to_results_directory, k));
        ...
        print('-dpng', '-r300', sprintf('%splot_u_iteration%d.png', path_to_outputs_directory, k));
        ...
        set(gcf, 'PaperUnits', 'inches', 'PaperPosition', [0, 0, 40, 22.5]);
        print('-dpng', '-r300', sprintf('%splot_c_iteration%d.png', path_to_outputs_directory, k));
