...
%  cylindrical bar in torsion. We use quadratic NURBS as basis functions.
%  
%  
%  Instructions:
%  
...
%   gauge_length = 50e-3;             % Length of the gauge section
    ...
    switch numRefinements
        case 0
            ...
            knotsForInsertion1 = 0.5;
            knotsForInsertion2 = [];
            knotsForInsertion3 = [0.5; 2.45; 2.6; (2 + temp); sort(4 - temp); 3.4; 3.55; 5.5];
            
        case 1
            temp = 0.5 + 0.5 * sqrt(setdiff((0 : 0.5^4 : 1)', [0; 1]));
            
            knotsForInsertion1 = [0.25; 0.5; 0.75];
            knotsForInsertion2 = [];
            knotsForInsertion3 = [0.25; 0.5; 0.75; 2.3; 2.45; 2.55; (2 + temp); sort(4 - temp); 3.45; 3.55; 3.7; 5.25; 5.5; 5.75];
            
        case 2
            temp = 0.5 + 0.5 * sqrt(setdiff((0 : 0.5^5 : 1)', [0; 1]));
            
            knotsForInsertion1 = [0.25; 0.5; 0.75];
            knotsForInsertion2 = [0.5; 1.5; 2.5; 3.5];
            knotsForInsertion3 = [0.25; 0.5; 0.75; 2.3; 2.45; 2.55; (2 + temp); sort(4 - temp); 3.45; 3.55; 3.7; 5.25; 5.5; 5.75];
