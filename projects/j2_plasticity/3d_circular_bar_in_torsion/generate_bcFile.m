function generate_bcFile(numRefinements)
    ...
    %   Set load step 1
    %   
    %   Here, we fix the top grip and rotate the bottom grip about the
    %   z-axis by 20 degrees.
    % ---------------------------------------------------------------------
    %----------------------------------------------------------------------
    ...
    % Find the element index of the grip along direction 3
    ...
    % r-theta surface, z = 0
    elementIndex = find_element_index((1 : numElements1)', (1 : numElements2)', 1, numElements1, numElements2, numElements3);
    ...
    elementIndex = find_element_index(numElements1, (1 : numElements2)', elementIndex3_grip, numElements1, numElements2, numElements3);
    ...
    elementIndex = find_element_index((1 : numElements1)', (1 : numElements2)', numElements3, numElements1, numElements2, numElements3);
