...
function postprocess(path_to_assembly_directory, path_to_results_directory, path_to_outputs_directory, time_index)
        ...
        for e3 = 1 : numElements3
            ...
            for e2 = 1 : numElements2
                ...
                for e1 = 1 : numElements1
                    ...
                    %------------------------------------------------------
                    draw_3d_element(z, y, x, numPointsPerElementCoordinate);
    ...
    xlabel('z', 'FontSize', 90);
    ylabel('x', 'FontSize', 90, 'Rotation', 0);
    zlabel('y', 'FontSize', 90, 'Rotation', 0);
    view([-45, -25]);
    axis image;
    axis([0 0.17 -0.01 0.01 -0.01 0.01]);
    grid on;
    set(gca, 'FontSize', 54);
