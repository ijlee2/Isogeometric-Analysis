function generate_bcFile(numRefinements)
    ...
    %----------------------------------------------------------------------
    %  Displacements for the left side of the quarter annulus
    %----------------------------------------------------------------------
    ...
    BCs_displacement = [BCs_displacement; ...
                        [kron(GN_array(nodeIndex), ones(2, 1)), repmat(dofIndex, BCs_numNodes, 1), repmat(bcValue, BCs_numNodes, 1)]];
    
    
    %----------------------------------------------------------------------
    %  Displacements for the bottom side of the quarter annulus
    %----------------------------------------------------------------------
    % Degrees of freedom and BC values
    dofIndex = [1; 2];
    bcValue = [0; 0];
