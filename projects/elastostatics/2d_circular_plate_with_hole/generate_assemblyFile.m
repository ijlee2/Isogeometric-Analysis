...
%  Summary:
%  
%  This routine creates the assembly files for the problem of a 2D circular
...
function generate_assemblyFile(numRefinements)
    ...
    %  Set the description
    %----------------------------------------------------------------------
    patches(1).description = strcat('2D circular plate with a circular hole, refinement level', sprintf(' %d', numRefinements));
    ...
    patches(1).nodes = [0           , hole_radius , 1       ; ...
                        hole_radius , hole_radius , w_circle; ...
                        hole_radius , 0           , 1       ; ...
                        ...
                        0           , plate_length, 1       ; ...
                        plate_length, plate_length, w_circle; ...
                        plate_length, 0           , 1       ];
    ...
    temp = setdiff((0 : 0.5^(numRefinements + 1) : 1)', [0; 1]);
    
    knotsForInsertion1 = temp;
    knotsForInsertion2 = temp;
